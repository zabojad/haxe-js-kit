...
{
  static function rename(from:String,to:String,cb:Callback<Void>):Void;
  ...
  static function link(srcPath:String,dstPath:String,cb:Callback<Void>):Void;
  static function linkSync(srcPath:String,dstPath:String):Void;

  static function unlink(path:String,cb:Callback<Void>):Void;
  static function unlinkSync(path:String):Void;
  
  @:overload(function(linkData:Dynamic,path:String,type:String,?cb:Callback<Void>):Void {})
  static function symlink(linkData:Dynamic,path:String,?cb:Callback<Void>):Void;
  ...
  static function chmod(path:String,mode:Int,cb:Callback<Void>):Void;
  static function chmodSync(path:String,?mode:Int):Void;

  static function fchmod(fd:Int,mode:Int,cb:Callback<Void>):Void;
  static function fchmodSync(fd:Int,?mode:Int):Void;

  static function chown(path:String,uid:Int,gid:Int,cb:Callback<Void>):Void ;
  static function chownSync(path:String,uid:Int,gid:Int):Void;
  
  static function fchown(fd:Int,uid:Int,gid:Int,cb:Callback<Void>):Void ;
  static function fchownSync(fd:Int,uid:Int,gid:Int):Void;

  static function rmdir(path:String,cb:Callback<Void>):Void;
  static function rmdirSync(path:String):Void;
  
  @:overload(function(path:String,mode:Int,?cb:Callback<Void>):Void {})
  static function mkdir(path:String,?cb:Callback<Void>):Void;
  ...
  static function close(fd:Int,cb:Callback<Void>):Void;
  ...
  @:overload(function(fileName:String,contents:String,enc:String,cb:Callback<Void>):Void {})
  static function writeFile(fileName:String,contents:String,cb:Callback<Void>):Void;
  ...
  @:overload(function(fileName:String,data:Buffer,cb:Callback<Void>):Void {})
  @:overload(function(fileName:String,contents:String,enc:String,cb:Callback<Void>):Void {})
  static function appendFile(fileName:String,contents:String,cb:Callback<Void>):Void;

  @:overload(function(fileName:String,data:Buffer):Void {})
  static function appendFileSync(fileName:String,contents:String,?enc:String):Void;

  
  static function utimes(path:String,atime:Dynamic,mtime:Dynamic,cb:Callback<Void>):Void;
  static function utimeSync(path:String,atime:Dynamic,mtime:Dynamic):Void;

  static function futimes(fd:Int,atime:Dynamic,mtime:Dynamic,cb:Callback<Void>):Void;
  static function futimeSync(fd:Int,atime:Dynamic,mtime:Dynamic):Void;

  static function fsync(fd:Int,cb:Callback<Void>):Void;
